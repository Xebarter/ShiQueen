        ...
        <section className="relative overflow-hidden border-b border-border/60">
          ...
          <div className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              Sign up as a supplier, list products and packages, and reach customers once
              your account is approved by our team.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/supplier/sign-up"
          ...
          <div className="mt-10 rounded-2xl border border-border/70 bg-muted/30 p-6 sm:p-8">
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              {[
                ...
                'Add products and packages while your application is reviewed.',
                'Once approved, your listings appear on the public SheQueen storefront.',
              ].map((step) => (
