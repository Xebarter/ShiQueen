  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        ...
        <h3 className="mt-1.5 line-clamp-2 text-sm font-semibold leading-snug tracking-tight sm:mt-2 sm:text-[15px]">
          {product.name}
        </h3>

        <div className="mt-2.5 flex items-end justify-between gap-2 border-t border-border/50 pt-2.5 sm:mt-3 sm:gap-3 sm:pt-3">
          <div>
            <p className="text-[10px] text-muted-foreground line-through sm:text-[11px]">
              {formatUGX(product.price)}
            </p>
            <p className="mt-0.5 text-lg font-semibold tracking-tight tabular-nums text-foreground sm:text-xl">
              {formatUGX(unitPrice)}
            ...
            {savingsPerUnit > 0 ? (
              <p className="mt-0.5 text-[10px] font-medium text-primary sm:text-[11px]">
                Save {formatUGX(savingsPerUnit)}
              </p>
            ) : null}
          </div>
          <p className="rounded-md bg-muted/60 px-1.5 py-1 text-[9px] font-semibold uppercase tracking-wide text-muted-foreground sm:px-2 sm:text-[10px]">
            MOQ {minQty}
          </p>
        </div>
        ...
        <Button
          className="mt-3 h-10 w-full gap-2 rounded-lg text-xs font-semibold sm:mt-4 sm:h-11 sm:text-sm"
