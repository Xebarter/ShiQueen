    ...
    >
      <div className="relative overflow-hidden">
        ...
        >
          ...
          {savingsAmount > 0 && (
            <span className="absolute bottom-3 right-3 rounded-full bg-accent px-3 py-1 text-xs font-bold text-accent-foreground shadow-md">
      ...
      <div className={cn('flex flex-1 flex-col', isCompact ? 'p-3.5' : 'p-4 sm:p-5')}>
        ...
        <div className={cn('mt-4 grid gap-2', isCompact ? 'grid-cols-1' : 'grid-cols-2 sm:grid-cols-3')}>
          {onQuickView && !isCompact && (
            <Button
              type="button"
              variant="outline"
              size="sm"
